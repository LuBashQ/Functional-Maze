...
let main () =     
    ...
    let menu = Menu("menu",None,showMenu,["NORMAL";"HARDCORE";"SOLVED";"OPTIONS";"HELP"],0,(W,H))
    ...
    "Q to quit";"NORMAL to play a standard game";"HARDCORE to have a challenge";"OPTIONS to change settings";"MENU"],(W,H),(W/5+2,15),0)
    let win = Text("win",None,showText,["YOU WON";"MENU"],(W,H),(W/2-3,H/2-2),0)
